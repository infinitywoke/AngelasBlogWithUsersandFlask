...
class RegisterForm(Form):
    email = StringField('E-mail id', [validators.Length(min=6, max=35)])
...
def register():
    ...
    if form.validate_on_submit():
        ...
        hashed = generate_password_hash(form.password.data, 'pbkdf2:sha256', 8)
...
def login():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            check = check_password_hash(pw, form.password.data)
        if not check:
